...
define( 'DB_HOST', 'c093um.forpsi.com:3306' ); // set database host
define( 'DB_USER', 'f103094' ); // set database user
define( 'DB_PASS', 'mquNS25' ); // set database password
define( 'DB_NAME', 'dorty' ); // set database name
